...
const Report = () => {
    ...
    const calculateNetProfit = () => {
        ...
        const debt = parseFloat(inputs.total_debt) || 0;
    ...
    const handleSaveReport = async () => {
        if (!inputs.cash_in_hand || !inputs.total_debt) {
            setError('Please enter Cash in Hand and Total Debt');
            return;
        }
                        ...
                        <div className="report-card">
                            ...
                            <div className="input-grid">
                                <div className="input-group">
                                    <label>Total Cash (Money in Account)</label>
                                    <input
                                        type="number"
                                        name="cash_in_hand"
                        ...
                        <div className="table-container">
                            <table className="data-table">
                                ...
                                <tbody>
                                    {history.length === 0 ? (
                                        <tr>
                                            <td colSpan="9" style={{ textAlign: 'center', padding: '20px' }}>No reports found</td>
                                        </tr>
                                    ) : (
                                        history.map(report => (
                                            <tr key={report.id}>
