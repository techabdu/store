...
PRHub provides a unified platform to manage your entire retail business. Whether you are a single shop or a multi-location enterprise, PRHub scales to meet your needs.
...
This documentation is improved to guide you through every aspect of the application:

*   **Getting Started**: Essentials for setting up your account and shop.
*   **User Guide**: Detailed instructions for staff members on using the POS and managing their daily tasks.
*   **Admin Guide**: Advanced management features for shop owners and managers.

Use the navigation sidebar on the left to browse through the topics.
